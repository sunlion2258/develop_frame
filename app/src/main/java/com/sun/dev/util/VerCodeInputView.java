...
/**
 * Created by SunLion on 2019/12/31.
 * 验证码输入框
 * EditText字号极小，且颜色透明
 */
...
public class VerCodeInputView extends FrameLayout {
    ...
    public VerCodeInputView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inputNum = 6;
        inputWidth = DensityUtil.dip2px(context, 43);
        inputHeight = inputWidth;
        childPadding = DensityUtil.dip2px(context, 7.5f);
        textColor = getResources().getColor(R.color.color_333333);
        textSize = 24;
        editTextBg = R.drawable.bg_edit_vercode;
